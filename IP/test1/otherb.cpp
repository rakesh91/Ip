    ...
    QWidget(parent),expend(),dab()
{
    ...
    qDebug()<<"=-=-=-=-="<<"---"<<query.exec("create table othertable4(amount varchar(10),location varchar(40),date varchar(40),time varchar(29) primary key )" );
          qDebug()<<"here1";
...
query1.prepare("INSERT INTO othertable4(amount,location,date,time) "
