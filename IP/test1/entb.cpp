    ...
    QWidget(parent),expend(),dab()
{
    ...
    qDebug()<<"=-=-=-=-="<<"---"<<query.exec("create table entable4(amount varchar(10),location varchar(40),date varchar(40),time varchar(29) primary key )" );
          qDebug()<<"here1";
...
query1.prepare("INSERT INTO entable4(amount,location,date,time) "
